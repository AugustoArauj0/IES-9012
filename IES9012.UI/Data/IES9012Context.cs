...
namespace IES9012.UI.Data
{
    public class IES9012Context : DbContext
    {
        ...
        public DbSet<IES9012.CORE.Models.Estudiante>? Estudiantes { get; set; }
        public DbSet<IES9012.CORE.Models.Materia>? Materias { get; set; }
        public DbSet<IES9012.CORE.Models.Inscripcion>? Inscripciones { get; set; }
